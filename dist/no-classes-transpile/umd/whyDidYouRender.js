...
(function (global, factory) {
  ...
  var diffTypesDescriptions = (_diffTypesDescription = {}, _defineProperty$1(_diffTypesDescription, diffTypes.different, 'different objects.'), _defineProperty$1(_diffTypesDescription, diffTypes.deepEquals, 'different objects that are equal by value.'), _defineProperty$1(_diffTypesDescription, diffTypes.date, 'different date objects with the same value.'), _defineProperty$1(_diffTypesDescription, diffTypes.regex, 'different regular expressions with the same value.'), _defineProperty$1(_diffTypesDescription, diffTypes.reactElement, 'different React elements with the same displayName.'), _defineProperty$1(_diffTypesDescription, diffTypes.function, 'different functions with the same name.'), _diffTypesDescription);
  ...
  function logDifference(Component, displayName, prefixMessage, propsOrSate, differences, values, options) {
    if (differences && differences.length > 0) {
      options.consoleLog(_defineProperty$1({}, displayName, Component), "".concat(prefixMessage, " of ").concat(propsOrSate, " changes:"));
  ...
  function defaultNotifier(updateInfo) {
    ...
    if (!reason.propsDifferences && !reason.stateDifferences) {
      options.consoleLog(_defineProperty$1({}, displayName, Component), 'Re-rendered although props and state objects are the same.', 'This usually means there was a call to this.forceUpdate() inside the component.', "more info at ".concat(moreInfoUrl));
    }
  ...
  function getDisplayName(type) {
    return type.displayName || type.name || type.type && getDisplayName(type.type) || (isString_1(type) ? type : undefined);
  }
  ...
  function patchMemoComponent(MemoComponent, displayName, React, options) {
    ...
    defaults_1(WDYRFunctionalComponent, WDYRFunctionalComponent);
