...
(function (global, factory) {
  ...
  function patchMemoComponent(MemoComponent, displayName, React, options) {
    ...
    var MemoComponentExtra = omit_1(MemoComponent, Object.keys(WDYRMemoizedFunctionalComponent));

    InnerWDYRMemoizedFunctionalComponent.displayName = displayName;

    defaults_1(InnerWDYRMemoizedFunctionalComponent, MemoComponentExtra);
