...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('lodash/get'), require('lodash/isString'), require('lodash/reduce'), require('lodash/has'), require('lodash/keys'), require('lodash/isSet'), require('lodash/isFunction'), require('lodash/isRegExp'), require('lodash/isDate'), require('lodash/isPlainObject'), require('lodash/isArray'), require('lodash/defaults')) :
  typeof define === 'function' && define.amd ? define(['lodash/get', 'lodash/isString', 'lodash/reduce', 'lodash/has', 'lodash/keys', 'lodash/isSet', 'lodash/isFunction', 'lodash/isRegExp', 'lodash/isDate', 'lodash/isPlainObject', 'lodash/isArray', 'lodash/defaults'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.whyDidYouRender = factory(global.lodash.get, global.lodash.isString, global.lodash.reduce, global.lodash.has, global.lodash.keys, global.lodash.isSet, global.lodash.isFunction, global.lodash.isRegExp, global.lodash.isDate, global.lodash.isPlainObject, global.lodash.isArray, global.lodash.defaults));
}(this, (function (_get$1, _isString, _reduce, _has, _keys, _isSet, _isFunction, _isRegExp, _isDate, _isPlainObject, _isArray, _defaults) { 'use strict';

  _get$1 = _get$1 && Object.prototype.hasOwnProperty.call(_get$1, 'default') ? _get$1['default'] : _get$1;
  _isString = _isString && Object.prototype.hasOwnProperty.call(_isString, 'default') ? _isString['default'] : _isString;
  _reduce = _reduce && Object.prototype.hasOwnProperty.call(_reduce, 'default') ? _reduce['default'] : _reduce;
  _has = _has && Object.prototype.hasOwnProperty.call(_has, 'default') ? _has['default'] : _has;
  _keys = _keys && Object.prototype.hasOwnProperty.call(_keys, 'default') ? _keys['default'] : _keys;
  _isSet = _isSet && Object.prototype.hasOwnProperty.call(_isSet, 'default') ? _isSet['default'] : _isSet;
  _isFunction = _isFunction && Object.prototype.hasOwnProperty.call(_isFunction, 'default') ? _isFunction['default'] : _isFunction;
  _isRegExp = _isRegExp && Object.prototype.hasOwnProperty.call(_isRegExp, 'default') ? _isRegExp['default'] : _isRegExp;
  _isDate = _isDate && Object.prototype.hasOwnProperty.call(_isDate, 'default') ? _isDate['default'] : _isDate;
  ...
  _isArray = _isArray && Object.prototype.hasOwnProperty.call(_isArray, 'default') ? _isArray['default'] : _isArray;
  _defaults = _defaults && Object.prototype.hasOwnProperty.call(_defaults, 'default') ? _defaults['default'] : _defaults;
  ...
  function trackHookChanges(hookName, _ref, hookResult, React, options, ownerDataMap, hooksRef) {
    ...
    var nextHook = hookPath ? _get$1(hookResult, hookPath) : hookResult;
