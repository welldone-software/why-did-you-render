  ...
  function accumulateDeepEqualDiffs(a, b, diffsAccumulator) {
    ...
    if (isArray_1(a) && isArray_1(b)) {
      ...
      for (var i = arrayLength; i--; i > 0) {
        accumulateDeepEqualDiffs(a[i], b[i], arrayItemDiffs, "".concat(pathString, "[").concat(i, "]"));
      }

      var numberOfDeepEqualsItems = countDeepEquals(arrayItemDiffs);
    ...
    if (isPlainObject_1(a) && isPlainObject_1(b)) {
      ...
      for (var _i2 = keysLength; _i2--; _i2 > 0) {
        var key = keys[_i2];
        accumulateDeepEqualDiffs(a[key], b[key], objectValuesDiffs, "".concat(pathString, ".").concat(key));
      }

      var numberOfDeepEqualsObjectValues = countDeepEquals(objectValuesDiffs);
