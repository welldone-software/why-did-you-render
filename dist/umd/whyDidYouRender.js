/**
 * @welldone-software/why-did-you-render 3.3.1-alpha.0
 * MIT Licensed
...
(function (global, factory) {
  ...
  function patchMemoComponent(MemoComponent, displayName, React, options) {
    ...
    function WDYRWrappedByMemoFunctionalComponent(nextProps) {
      ...
      return WrappedFunctionalComponent.apply(void 0, [nextProps].concat(otherArgs));
    }
    ...
    defaults_1(WDYRWrappedByMemoFunctionalComponent, WrappedFunctionalComponent);
  ...
  function patchForwardRefComponent(ForwardRefComponent, displayName, React, options) {
    ...
    function WDYRWrappedByReactForwardRefFunctionalComponent(nextProps) {
      var ref = React.useRef();
      var prevProps = ref.current;
      ref.current = nextProps;
  ...
  function trackHookChanges(hookName, _ref, hookResult, React, options) {
    ...
    if (prevHook) {
      var notification = getUpdateInfo({
        ...
        displayName: displayName,
        hookName: hookName,
        prevHook: hookPath ? get_1(prevHook, hookPath) : prevHook,
        nextHook: hookPath ? get_1(nextHook, hookPath) : nextHook,
        options: options
      });
  ...
  function whyDidYouRender(React, userOptions) {
    ...
    if (options.trackHooks) {
      var patchedHooks = mapValues_1(hooksConfig, function (hookConfig, hookName) {
        return function () {
      ...
      Object.defineProperty(React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher, 'current', {
        set: function set(newHooks) {
          origHooks = newHooks && _objectSpread2({}, newHooks, {}, newHooks.origHooks);
        },
        get: function get() {
          return origHooks && _objectSpread2({}, origHooks, {}, patchedHooks, {
            origHooks: origHooks
          });
        }
      });
